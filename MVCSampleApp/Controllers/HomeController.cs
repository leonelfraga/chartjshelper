...
namespace MVCSampleApp.Controllers
{
    public class HomeController : Controller
    {
		...
		private void GeneratePieChart()
		{
			...
			ViewBag.PieChart = ChartHelper.Instance.GeneratePieChart("Sample Pie Chart", pointCollection.ToArray(), String.Format("Total: {0}", sumValues));
		}
		...
		private void GenerateDoughnutChart()
		{
			...
			//Raw HTML is stored in ViewBag for view rendering using @Html.Raw method
			ViewBag.DoughnutChart = ChartHelper.Instance.GenerateDoughnutChart("Sample Doughnut Chart", pointCollection.ToArray(), String.Format("Total: {0}", sumValues));
		}
		...
		private void GenerateLineChart()
		{
			...
			ViewBag.LineChart = ChartHelper.Instance.GenerateLineChart("Voting intentions for 2018 Presidential Brazilian Elections",
		...
		private void GenerateBarChart()
		{
			...
			ViewBag.BarChart = ChartHelper.Instance.GenerateBarChart("Requests x State",
